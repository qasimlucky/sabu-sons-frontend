...
function Sidebar (){
    ...
    const handleClick = event => {
      ...
      const handlesalemanclass = event => {
        // 👇️ toggle isActive state on click
        setIsSaleman(current => !current);
      }
      ...
      let  salemanclass=  isSaleman? ' active' :null;
       ...
       return (
        <div class="main-sidebar sidebar-style-2">
                ...
                <ul class="sidebar-menu">
                    ...
                    <a class="menu-toggle nav-link has-dropdown" onClick={handleClick}><i data-feather="command"></i><span>Dealers</span></a>
                    ...
                    <a class="menu-toggle nav-link has-dropdown" onClick={handleMe}><i data-feather="mail"></i><span>Product</span></a>
                    <ul class="dropdown-menu">
                        ...
                        <li><Link class="nav-link" to="/addstock">Add Product</Link></li>
                        <li><Link class="nav-link" to="/allstock">List & Edit product</Link></li>
                        <li><Link class="nav-link" to="/categories"> All Product Categories</Link></li>
                        <li><Link class="nav-link" to="/addcategories">Add Product Categories</Link></li>

                        
                    </ul>
                    </li>
                    <li className={`dropdown${billclass}`}>
                    <a class="menu-toggle nav-link has-dropdown" onClick={handlebillclass}><i data-feather="mail"></i><span>Orders</span></a>
                    <ul class="dropdown-menu">
                    ...
                    <a class="menu-toggle nav-link has-dropdown" onClick={handlepartnerclass}><i data-feather="mail"></i><span>Partners</span></a>
                    <ul class="dropdown-menu">
                        <li><Link class="nav-link" to="/partner">All Partners</Link></li>
                        <li><Link class="nav-link" to="/addpartner">Add Partner</Link></li>
                    </ul>
                    </li>
                    <li className={`dropdown${salemanclass}`}>
                    <a  class="menu-toggle nav-link has-dropdown" onClick={handlesalemanclass}><i data-feather="mail"></i><span>Saleman</span></a>
                    <ul class="dropdown-menu">
                        <li><Link class="nav-link" to="/saleman">All Saleman</Link></li>
                        <li><Link class="nav-link" to="/addsaleman">Add Saleman</Link></li>
                    </ul>
                    </li>
                    <li className={`dropdown${agentclass}`}>
                    <a class="menu-toggle nav-link has-dropdown" onClick={handleagentclass}><i data-feather="mail"></i><span>Agents</span></a>
                    <ul class="dropdown-menu">
                    ...
                    <a  class="menu-toggle nav-link has-dropdown" onClick={handlesupplierclass}><i data-feather="mail"></i><span>Supplier</span></a>
                    <ul class="dropdown-menu">
                    ...
                    <a class="menu-toggle nav-link has-dropdown" onClick={handlepurchaseclass}><i data-feather="mail"></i><span>Purchases</span></a>
                    <ul class="dropdown-menu">
