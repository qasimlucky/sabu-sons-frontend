...
function AddSaleman(props) {
  ...
  const url = "https://subo-sons-backend.onrender.com/saleman/add"
  function submit(e) {
    console.log(data)
    e.preventDefault();
    axios
                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <form onSubmit={(e) => submit(e)} method="HTTP_METHOD" enctype="multipart/form-data">
                      ...
                      <label className="badge badge-primary badge-shadow" style={{ padding: "8px" }}>Saleman Details</label>
                      <div class="row">
