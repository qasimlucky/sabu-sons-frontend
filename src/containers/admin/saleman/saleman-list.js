...
function Saleman() {
  ...
  const [itemOffset, setItemOffset] = useState(0);
    ...
    useEffect(() => {
      axios.get("https://subo-sons-backend.onrender.com/saleman/get").then(Response =>{
    ...
    function OpenTransactions(partnerDetails) {
      ...
      navigate("/salemantransaction",{state:{sendData:partnerDetails}})
    }
              ...
              <div className="card">
                <div className="card-header">
                  ...
                  <div className="card-header-form">
                    <Link to="/addsaleman" className="btn btn-success ">
                      + Add Saleman
                    </Link>
                  </div>
                </div>
